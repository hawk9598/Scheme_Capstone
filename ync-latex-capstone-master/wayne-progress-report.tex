...
\thesistitle{Self-interpreters in Scheme} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\author{Qin Wayne \textsc{Toh}} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
...
\includepdf[pages=-,pagecommand={},width=\textwidth]{titlepage_progress.pdf}
...
\input{chapters/progress_report_chapter}
