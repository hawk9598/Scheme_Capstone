...
let test_eval_cps_Scheme_base_values candidate =
  (* Test on integers *)
...
let test_eval_cps_Scheme_non_base_values candidate =
  ...
  and b28 = (candidate (get_final_parsed_exp "((lambda (x . y) (+ x (car y))) 1 2 3)")
               default_empty_alist = Int 3)
  (* Test on call/cc expression *)
  and b29 = (candidate (get_final_parsed_exp "(+ 1 (call/cc (lambda (k) 10)))")
               default_empty_alist = Int 11)
  and b30 = (candidate (get_final_parsed_exp "(+ 1 (call/cc (lambda (k) (k 10))))")
               default_empty_alist = Int 11)
  and b31 = (candidate (get_final_parsed_exp "(+ 1 (call/cc (lambda (k) (/ (k 10) 0))))")
               default_empty_alist = Int 11)
  and b32 = (candidate (get_final_parsed_exp "(/ 100 (call/cc (lambda (k) (/ (k 25) 0))))")
               default_empty_alist = Int 4)
  (* Test on apply expression *)
  and b33 = (candidate (get_final_parsed_exp "(apply (lambda (n) n) '(5))")
               default_empty_alist = Int 5)
  and b34 = (candidate (get_final_parsed_exp "(apply (lambda xs (car xs)) '(6 7))")
               default_empty_alist = Int 6)
  and b35 = (candidate (get_final_parsed_exp "(apply apply (list (lambda (a b) (+ a (+ b 1))) (list 10 20)))")
               default_empty_alist = Int 31)
  and b36 = (candidate (get_final_parsed_exp "(+ 1 (apply call/cc (list (lambda (k) 10))))")
               default_empty_alist = Int 11)
  and b37 = (candidate (get_final_parsed_exp "(+ 1 (apply call/cc (list (lambda (k) (/ (k 10) 0)))))")
               default_empty_alist = Int 11)
  in b0 && b1 && b2 && b3 && b4 && b5 && b6 && b7 && b8 && b9 && b10 && b11 && b12 && b13 && b14 && b15 && b16 && b17 && b18 && b19 && b20 && b21 && b22 && b23 && b24 && b25 && b26 && b27 && b28 && b29 && b30 && b31 && b32 && b33 && b34 && b35 && b36 && b37;;
  
assert (test_eval_cps_Scheme_base_values eval_cps_with_cont);;
assert (test_eval_cps_Scheme_non_base_values eval_cps_with_cont);;
