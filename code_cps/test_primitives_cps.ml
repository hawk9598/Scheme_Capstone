...
let test_internal_is_pair_error candidate =
  let b0 = (try ignore (candidate [Pair(Int 5, Int 3);
                ...
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (pair? [(5 , 3); (true , false)])") -> ())
  and b1 = (try ignore (candidate [Int 5; Int 3; Int 4]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (pair? [5; 3; 4])") -> ())
  and b2 = (try ignore (candidate [Boolean true; Int 5; Character 's';
                                   String "hi"; Null]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (pair? [true; 5; 's'; \"hi\"; []])") -> ())
  and b3 = (try ignore (candidate []);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (pair? [])") -> ())
  in b0; b1; b2; b3;;
...
let test_internal_cons_error candidate =
  let b0 = (try ignore (candidate [Int 5]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (cons [5])") -> ())
  and b1 = (try ignore (candidate []);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (cons [])") -> ())
  and b2 = (try ignore (candidate [Int 5; Pair(Boolean true,
                                               Character '9'); Null]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (cons [5; (true , '9'); []])") -> ())
  and b3 = (try ignore (candidate [Int 5; Boolean true; Character 'j';
                                   String "hello"; Null]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (cons [5; true; 'j'; \"hello\"; []])") -> ())
  in b0; b1; b2; b3;;
...
let test_internal_car_error candidate =
  ...
  let b0 = (try ignore (candidate []);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (car [])") -> ())
  and b1 = (try ignore (candidate [Pair(Int 5,
                                        Int 3); Pair(Null,
                                                     Character 'l')]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (car [(5 , 3); ([] , 'l')])") -> ())
  and b2 = (try ignore (candidate [Pair(Int 5,
                                        Boolean true); Int 100]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (car [(5 , true); 100])") -> ())
  and b3 = (try ignore (candidate [Int 5; Int 100; Boolean true; Null]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (car [5; 100; true; []])") -> ())
  (* test for incorrect type of input argument *)
  and b4 = (try ignore (candidate [Int 100]);
                failwith "Error not raised" with Primitives_cps.Error("Error in car: 100 is not a pair.") -> ())
  and b5 = (try ignore (candidate [Character 'i']);
                failwith "Error not raised" with Primitives_cps.Error("Error in car: 'i' is not a pair.") -> ())
  and b6 = (try ignore (candidate [Boolean false]);
                failwith "Error not raised" with Primitives_cps.Error("Error in car: false is not a pair.") -> ())
  and b7 = (try ignore (candidate [String "capstone"]);
                failwith "Error not raised" with Primitives_cps.Error("Error in car: \"capstone\" is not a pair.") -> ())
  and b8 = (try ignore (candidate [Null]);
                failwith "Error not raised" with Primitives_cps.Error("Error in car: [] is not a pair.") -> ())
  and b9 = (try ignore (candidate [Closure identity]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in car: Closure function is not a pair.") -> ())
  and b10 = (try ignore (candidate [Primitive internal_add]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in car: Primitive function is not a pair.") -> ())
...
let test_internal_cdr_error candidate =
  (* test for incorrect number of arguments first *)
  let b0 = (try ignore (candidate []);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (cdr [])") -> ())
  and b1 = (try ignore (candidate [Pair(Int 5,
                                        Int 3); Pair(Null,
                                                     Character 'l')]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (cdr [(5 , 3); ([] , 'l')])") -> ())
  and b2 = (try ignore (candidate [Pair(Int 5,
                                        Boolean true); Int 100]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (cdr [(5 , true); 100])") -> ())
  and b3 = (try ignore (candidate [Int 5; Int 100; Boolean true; Null]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (cdr [5; 100; true; []])") -> ())
  (* test for incorrect type of input argument *)
  and b4 = (try ignore (candidate [Int 100]);
                failwith "Error not raised" with Primitives_cps.Error("Error in cdr: 100 is not a pair.") -> ())
  and b5 = (try ignore (candidate [Character 'i']);
                failwith "Error not raised" with Primitives_cps.Error("Error in cdr: 'i' is not a pair.") -> ())
  and b6 = (try ignore (candidate [Boolean false]);
                failwith "Error not raised" with Primitives_cps.Error("Error in cdr: false is not a pair.") -> ())
  and b7 = (try ignore (candidate [String "capstone"]);
                failwith "Error not raised" with Primitives_cps.Error("Error in cdr: \"capstone\" is not a pair.") -> ())
  and b8 = (try ignore (candidate [Null]);
                failwith "Error not raised" with Primitives_cps.Error("Error in cdr: [] is not a pair.") -> ())
  and b9 = (try ignore (candidate [Closure identity]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in cdr: Closure function is not a pair.") -> ())
  and b10 = (try ignore (candidate [Primitive internal_add]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in cdr: Primitive function is not a pair.") -> ())
  in b0; b1; b2; b3; b4; b5; b6; b7; b8; b9; b10;;
...
let test_internal_is_int_error candidate =
  let b0 = (try ignore (candidate [Pair(Int 5, Int 3);
                                   Pair(Boolean true, Boolean false)]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (integer? [(5 , 3); (true , false)])") -> ())
  and b1 = (try ignore (candidate [Int 5; Int 3; Int 4]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (integer? [5; 3; 4])") -> ())
  and b2 = (try ignore (candidate [Boolean true; Int 5; Character 's';
                                   String "hi"; Null]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (integer? [true; 5; 's'; \"hi\"; []])") -> ())
  and b3 = (try ignore (candidate []);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (integer? [])") -> ())
  in b0; b1; b2; b3;;
...
let test_internal_is_zero_error candidate =
  (* test for incorrect number of arguments first *)
  let b0 = (try ignore (candidate []);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (zero? [])") -> ())
  and b1 = (try ignore (candidate [Int 0; Int 5]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (zero? [0; 5])") -> ())
  and b2 = (try ignore (candidate [Pair(Int 5,
                                        Boolean true); Int 100]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (zero? [(5 , true); 100])") -> ())
  and b3 = (try ignore (candidate [Int 5; Int 100; Boolean true; Null]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (zero? [5; 100; true; []])") -> ())
  (* test for incorrect type of input argument *)
  and b4 = (try ignore (candidate [Pair(Int 0,
                                        Int 0)]);
                failwith "Error not raised" with Primitives_cps.Error("Error in zero?: (0 , 0) is not a number.") -> ())
  and b5 = (try ignore (candidate [Character 'i']);
                failwith "Error not raised" with Primitives_cps.Error("Error in zero?: 'i' is not a number.") -> ())
  and b6 = (try ignore (candidate [Boolean false]);
                failwith "Error not raised" with Primitives_cps.Error("Error in zero?: false is not a number.") -> ())
  and b7 = (try ignore (candidate [String "capstone"]);
                failwith "Error not raised" with Primitives_cps.Error("Error in zero?: \"capstone\" is not a number.") -> ())
  and b8 = (try ignore (candidate [Null]);
                failwith "Error not raised" with Primitives_cps.Error("Error in zero?: [] is not a number.") -> ())
  and b9 = (try ignore (candidate [Closure identity]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in zero?: Closure function is not a number.") -> ())
  and b10 = (try ignore (candidate [Primitive internal_add]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in zero?: Primitive function is not a number.") -> ())
  in b0; b1; b2; b3; b4; b5; b6; b7; b8; b9; b10;;
...
let test_internal_is_positive_error candidate =
  (* test for incorrect number of arguments first *)
  let b0 = (try ignore (candidate []);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (positive? [])") -> ())
  and b1 = (try ignore (candidate [Int 5; Int 0]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (positive? [5; 0])") -> ())
  and b2 = (try ignore (candidate [Pair(Int 5,
                                        Boolean true); Int 100]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (positive? [(5 , true); 100])") -> ())
  and b3 = (try ignore (candidate [Int 5; Int 100; Boolean true; Null]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (positive? [5; 100; true; []])") -> ())
  (* test for incorrect type of input argument *)
  and b4 = (try ignore (candidate [Pair(Int 1,
                                        Int 2)]);
                failwith "Error not raised" with Primitives_cps.Error("Error in positive?: (1 , 2) is not a number.") -> ())
  and b5 = (try ignore (candidate [Character 'i']);
                failwith "Error not raised" with Primitives_cps.Error("Error in positive?: 'i' is not a number.") -> ())
  and b6 = (try ignore (candidate [Boolean false]);
                failwith "Error not raised" with Primitives_cps.Error("Error in positive?: false is not a number.") -> ())
  and b7 = (try ignore (candidate [String "capstone"]);
                failwith "Error not raised" with Primitives_cps.Error("Error in positive?: \"capstone\" is not a number.") -> ())
  and b8 = (try ignore (candidate [Null]);
                failwith "Error not raised" with Primitives_cps.Error("Error in positive?: [] is not a number.") -> ())
  and b9 = (try ignore (candidate [Closure identity]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in positive?: Closure function is not a number.") -> ())
  and b10 = (try ignore (candidate [Primitive internal_add]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in positive?: Primitive function is not a number.") -> ())
  in b0; b1; b2; b3; b4; b5; b6; b7; b8; b9; b10;;
...
let test_internal_is_negative_error candidate =
  (* test for incorrect number of arguments first *)
  let b0 = (try ignore (candidate []);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (negative? [])") -> ())
  and b1 = (try ignore (candidate [Int (-5); Int 0]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (negative? [~-5; 0])") -> ())
  and b2 = (try ignore (candidate [Pair(Int 5,
                                        Boolean true); Int 100]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (negative? [(5 , true); 100])") -> ())
  and b3 = (try ignore (candidate [Int 5; Int 100; Boolean true; Null]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (negative? [5; 100; true; []])") -> ())
  (* test for incorrect type of input argument *)
  and b4 = (try ignore (candidate [Pair(Int (-1),
                                        Int 2)]);
                failwith "Error not raised" with Primitives_cps.Error("Error in negative?: (~-1 , 2) is not a number.") -> ())
  and b5 = (try ignore (candidate [Character 'i']);
                failwith "Error not raised" with Primitives_cps.Error("Error in negative?: 'i' is not a number.") -> ())
  and b6 = (try ignore (candidate [Boolean false]);
                failwith "Error not raised" with Primitives_cps.Error("Error in negative?: false is not a number.") -> ())
  and b7 = (try ignore (candidate [String "capstone"]);
                failwith "Error not raised" with Primitives_cps.Error("Error in negative?: \"capstone\" is not a number.") -> ())
  and b8 = (try ignore (candidate [Null]);
                failwith "Error not raised" with Primitives_cps.Error("Error in negative?: [] is not a number.") -> ())
  and b9 = (try ignore (candidate [Closure identity]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in negative?: Closure function is not a number.") -> ())
  and b10 = (try ignore (candidate [Primitive internal_add]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in negative?: Primitive function is not a number.") -> ())
  in b0; b1; b2; b3; b4; b5; b6; b7; b8; b9; b10;;
...
let test_internal_is_even_error candidate =
  (* test for incorrect number of arguments first *)
  let b0 = (try ignore (candidate []);
                failwith "Error not raised" with Primitives_cps.Error
...
let test_internal_is_odd_error candidate =
  (* test for incorrect number of arguments first *)
  let b0 = (try ignore (candidate []);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (odd? [])") -> ())
  and b1 = (try ignore (candidate [Int (-5); Int 1]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (odd? [~-5; 1])") -> ())
  and b2 = (try ignore (candidate [Pair(Int 5,
                                        Boolean true); Int 100]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (odd? [(5 , true); 100])") -> ())
  and b3 = (try ignore (candidate [Int 5; Int 100; Boolean true; Null]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (odd? [5; 100; true; []])") -> ())
  (* test for incorrect type of input argument *)
  and b4 = (try ignore (candidate [Pair(Int (-1),
                                        Int 3)]);
                failwith "Error not raised" with Primitives_cps.Error("Error in odd?: (~-1 , 3) is not a number.") -> ())
  and b5 = (try ignore (candidate [Character 'i']);
                failwith "Error not raised" with Primitives_cps.Error("Error in odd?: 'i' is not a number.") -> ())
  and b6 = (try ignore (candidate [Boolean false]);
                failwith "Error not raised" with Primitives_cps.Error("Error in odd?: false is not a number.") -> ())
  and b7 = (try ignore (candidate [String "capstone"]);
                failwith "Error not raised" with Primitives_cps.Error("Error in odd?: \"capstone\" is not a number.") -> ())
  and b8 = (try ignore (candidate [Null]);
                failwith "Error not raised" with Primitives_cps.Error("Error in odd?: [] is not a number.") -> ())
  and b9 = (try ignore (candidate [Closure identity]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in odd?: Closure function is not a number.") -> ())
  and b10 = (try ignore (candidate [Primitive internal_add]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in odd?: Primitive function is not a number.") -> ())
  in b0; b1; b2; b3; b4; b5; b6; b7; b8; b9; b10;;
...
let test_internal_add_error candidate =
  let b0 = (try ignore (candidate [Boolean true]);
                failwith "Error not raised" with Primitives_cps.Error("Error in +: true is not a number.") -> ())
  and b1 = (try ignore (candidate [String "hello"]);
                failwith "Error not raised" with Primitives_cps.Error("Error in +: \"hello\" is not a number.") -> ())
  and b2 = (try ignore (candidate [Character '0']);
                failwith "Error not raised" with Primitives_cps.Error("Error in +: '0' is not a number.") -> ())
  and b3 = (try ignore (candidate [Pair (Int 1,
                                         Int 5)]);
                failwith "Error not raised" with Primitives_cps.Error("Error in +: (1 , 5) is not a number.") -> ())
  and b4 = (try ignore (candidate [Closure identity]);
                failwith "Error not raised" with Primitives_cps.Error("Error in +: Closure function is not a number.") -> ())
  and b5 = (try ignore (candidate [Primitive internal_add]);
                failwith "Error not raised" with Primitives_cps.Error("Error in +: Primitive function is not a number.") -> ())
  and b6 = (try ignore (candidate [Null]);
                failwith "Error not raised" with Primitives_cps.Error("Error in +: [] is not a number.") -> ())
...
let test_internal_sub_error candidate =
  (* test for incorrect number of arguments first *)
  let b0 = (try ignore (candidate []);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (- [])") -> ())
  ...
  and b9 = (try ignore (candidate [Character '9'; Int 2; Int (-3)]);
                failwith "Error not raised" with Primitives_cps.Error("Error in -: '9' is not a number.") -> ())
...
let test_internal_div_error candidate =
  ...
  and b13 = (try ignore (candidate [Int 100; Int 20; Int 0; Int 5]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in /: undefined for 0.") -> ())
...
let test_internal_quotient_error candidate =
  (* test for incorrect number of arguments first *)
  let b0 = (try ignore (candidate []);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (quotient [])") -> ())
  and b1 = (try ignore (candidate [Int 5]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (quotient [5])") -> ())
  and b2 = (try ignore (candidate [Int 5; Int (-3); Int 100]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (quotient [5; ~-3; 100])") -> ())
  and b3 = (try ignore (candidate [Int 5; Int (-3); Int 100; Int (-500)]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (quotient [5; ~-3; 100; ~-500])") -> ())
  and b4 = (try ignore (candidate [Null]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (quotient [[]])") -> ())
  and b5 = (try ignore (candidate [Boolean true; Int (-3); Int 100]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (quotient [true; ~-3; 100])") -> ())
  and b6 = (try ignore (candidate [Int 5; Int (-3); Character '8'; Int (-500)]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (quotient [5; ~-3; '8'; ~-500])") -> ())
  (* test for incorrect type of arguments *)
  and b7 = (try ignore (candidate [String "hello"; Int 10]);
                failwith "Error not raised" with Primitives_cps.Error("Error in quotient: \"hello\" is not a number.") -> ())
  and b8 = (try ignore (candidate [Character '5'; Int 10]);
                failwith "Error not raised" with Primitives_cps.Error("Error in quotient: '5' is not a number.") -> ())
  and b9 = (try ignore (candidate [Int (-100); Boolean false]);
                failwith "Error not raised" with Primitives_cps.Error("Error in quotient: false is not a number.") -> ())
  and b10 = (try ignore (candidate [Int 100; Pair(Int 10,
                                                  Int 10)]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in quotient: (10 , 10) is not a number.") -> ())
  and b11 = (try ignore (candidate [Closure identity; Primitive internal_div]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in quotient: Closure function is not a number.") -> ())
  and b12 = (try ignore (candidate [Character 'c'; String "quotient"]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in quotient: 'c' is not a number.") -> ())
  (* test for division by 0 *)
  and b13 = (try ignore (candidate [Int 100; Int 0]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in quotient: undefined for 0.") -> ())
...
let test_internal_remainder_error candidate =
  (* test for incorrect number of arguments first *)
  let b0 = (try ignore (candidate []);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (remainder [])") -> ())
  and b1 = (try ignore (candidate [Int 5]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (remainder [5])") -> ())
  and b2 = (try ignore (candidate [Int 5; Int (-3); Int 100]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (remainder [5; ~-3; 100])") -> ())
  and b3 = (try ignore (candidate [Int 5; Int (-3); Int 100; Int (-500)]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (remainder [5; ~-3; 100; ~-500])") -> ())
  and b4 = (try ignore (candidate [Null]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (remainder [[]])") -> ())
  and b5 = (try ignore (candidate [Boolean true; Int (-3); Int 100]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (remainder [true; ~-3; 100])") -> ())
  and b6 = (try ignore (candidate [Int 5; Int (-3); Character '8'; Int (-500)]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (remainder [5; ~-3; '8'; ~-500])") -> ())
  (* test for incorrect type of arguments *)
  and b7 = (try ignore (candidate [String "hello"; Int 10]);
                failwith "Error not raised" with Primitives_cps.Error("Error in remainder: \"hello\" is not a number.") -> ())
  and b8 = (try ignore (candidate [Character '5'; Int 10]);
                failwith "Error not raised" with Primitives_cps.Error("Error in remainder: '5' is not a number.") -> ())
  and b9 = (try ignore (candidate [Int (-100); Boolean false]);
                failwith "Error not raised" with Primitives_cps.Error("Error in remainder: false is not a number.") -> ())
  and b10 = (try ignore (candidate [Int 100; Pair(Int 10,
                                                  Int 10)]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in remainder: (10 , 10) is not a number.") -> ())
  and b11 = (try ignore (candidate [Closure identity; Primitive internal_div]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in remainder: Closure function is not a number.") -> ())
  and b12 = (try ignore (candidate [Character 'c'; String "quotient"]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in remainder: 'c' is not a number.") -> ())
  (* test for division by 0 *)
  and b13 = (try ignore (candidate [Int 100; Int 0]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in remainder: undefined for 0.") -> ())
  and b14 = (try ignore (candidate [Int (-100); Int 0]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in remainder: undefined for 0.") -> ())
  in b0; b1; b2; b3; b4; b5; b6; b7; b8; b9; b10; b11; b12; b13; b14;;
...
let test_internal_exponentiation_error candidate =
  ...
  let b0 = (try ignore (candidate []);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (expt [])") -> ())
  and b1 = (try ignore (candidate [Int 5]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (expt [5])") -> ())
  and b2 = (try ignore (candidate [Int 5; Int (-3); Int 100]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (expt [5; ~-3; 100])") -> ())
  and b3 = (try ignore (candidate [Int 5; Int (-3); Int 100; Int (-500)]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (expt [5; ~-3; 100; ~-500])") -> ())
  and b4 = (try ignore (candidate [Null]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (expt [[]])") -> ())
  and b5 = (try ignore (candidate [Boolean true; Int (-3); Int 100]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (expt [true; ~-3; 100])") -> ())
  and b6 = (try ignore (candidate [Int 5; Int (-3); Character '8'; Int (-500)]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (expt [5; ~-3; '8'; ~-500])") -> ())
  (* test for incorrect type of arguments *)
  and b7 = (try ignore (candidate [String "hello"; Int 5]);
                failwith "Error not raised" with Primitives_cps.Error("Error in expt: \"hello\" is not a number.") -> ())
  and b8 = (try ignore (candidate [Character '0'; Int 5]);
                failwith "Error not raised" with Primitives_cps.Error("Error in expt: '0' is not a number.") -> ())
  and b9 = (try ignore (candidate [Int (-100); Boolean false]);
                failwith "Error not raised" with Primitives_cps.Error("Error in expt: false is not a number.") -> ())
  and b10 = (try ignore (candidate [Int 100; Pair(Int 10,
                                                  Int 10)]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in expt: (10 , 10) is not a number.") -> ())
  and b11 = (try ignore (candidate [Closure identity; Primitive internal_div]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in expt: Closure function is not a number.") -> ())
  and b12 = (try ignore (candidate [Character 'c'; String "quotient"]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in expt: 'c' is not a number.") -> ())
  in b0; b1; b2; b3; b4; b5; b6; b7; b8; b9; b10; b11; b12;;
...
let test_internal_is_char_error candidate =
  let b0 = (try ignore (candidate [Pair(Character 'c', Int 3);
                ...
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (char? [('c' , 3); (true , '9')])") -> ())
  and b1 = (try ignore (candidate [Character '1'; Character 'a'; Character '/';
                                   Character '-'; Character '+']);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (char? ['1'; 'a'; '/'; '-'; '+'])") -> ())
  and b2 = (try ignore (candidate [Boolean true; Int 5; Character 's';
                                   String "hi"; Null]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (char? [true; 5; 's'; \"hi\"; []])") -> ())
  and b3 = (try ignore (candidate [Character '1'; Character 'a']);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (char? ['1'; 'a'])") -> ())
  and b4 = (try ignore (candidate []);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (char? [])") -> ())
  in b0; b1; b2; b3; b4;;
...
let test_internal_char_equal_error candidate =
  ...
  and b1 = (try ignore (candidate [Int 5]);
                failwith "Error not raised" with Primitives_cps.Error("Error in char=?: 5 is not a character.") -> ())
  and b2 = (try ignore (candidate [Boolean false]);
                failwith "Error not raised" with Primitives_cps.Error("Error in char=?: false is not a character.") -> ())
  and b3 = (try ignore (candidate [String "hello"]);
                failwith "Error not raised" with Primitives_cps.Error("Error in char=?: \"hello\" is not a character.") -> ())
  and b4 = (try ignore (candidate [Pair(Character 'c',
                                        Character '1')]);
                failwith "Error not raised" with Primitives_cps.Error("Error in char=?: ('c' , '1') is not a character.") -> ())
  and b5 = (try ignore (candidate [Closure identity]);
                failwith "Error not raised" with Primitives_cps.Error("Error in char=?: Closure function is not a character.") -> ())
  and b6 = (try ignore (candidate [Primitive internal_is_char]);
                failwith "Error not raised" with Primitives_cps.Error("Error in char=?: Primitive function is not a character.") -> ())
  ...
  and b7 = (try ignore (candidate [Character 'c'; Character 'b'; Boolean true]);
                failwith "Error not raised" with Primitives_cps.Error("Error in char=?: true is not a character.") -> ())
  and b8 = (try ignore (candidate [Character 'c'; Character 'c'; Null]);
                failwith "Error not raised" with Primitives_cps.Error("Error in char=?: [] is not a character.") -> ())
  and b9 = (try ignore (candidate [Int 5; Character 'c'; Character 'b']);
                failwith "Error not raised" with Primitives_cps.Error("Error in char=?: 5 is not a character.") -> ())
  and b10 = (try ignore (candidate [String "interpreter"; Character 'c';
                                    Character 'c']);
                 failwith "Error not raised" with Primitives_cps.Error("Error in char=?: \"interpreter\" is not a character.") -> ())
  in b0; b1; b2; b3; b4; b5; b6; b7; b8; b9; b10;;
...
let test_internal_char_numeric_error candidate =
  (* test for incorrect number of arguments *)
  let b0 = (try ignore (candidate []);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (char-numeric? [])") -> ())
  and b1 = (try ignore (candidate [Character '1'; Character '2']);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (char-numeric? ['1'; '2'])") -> ())
  and b2 = (try ignore (candidate [Character '1'; Character '2'; Character 'c']);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (char-numeric? ['1'; '2'; 'c'])") -> ())
  and b3 = (try ignore (candidate [Character '1'; Null]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (char-numeric? ['1'; []])") -> ())
  and b4 = (try ignore (candidate [Character '1'; Null; Int 500]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (char-numeric? ['1'; []; 500])") -> ())
  and b5 = (try ignore (candidate [Pair(Character '1',
                                        Character 'a'); Null; Int 500;
                                   Character 'c']);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (char-numeric? [('1' , 'a'); []; 500; 'c'])") -> ())
  (* test for incorrect type of argument *)
  and b6 = (try ignore (candidate [Int 5]);
                failwith "Error not raised" with Primitives_cps.Error("Error in char-numeric?: 5 is not a character.") -> ())
  and b7 = (try ignore (candidate [Boolean false]);
                failwith "Error not raised" with Primitives_cps.Error("Error in char-numeric?: false is not a character.") -> ())
  and b8 = (try ignore (candidate [String "hello"]);
                failwith "Error not raised" with Primitives_cps.Error("Error in char-numeric?: \"hello\" is not a character.") -> ())
  and b9 = (try ignore (candidate [Pair(Character 'c',
                                        Character '1')]);
                failwith "Error not raised" with Primitives_cps.Error("Error in char-numeric?: ('c' , '1') is not a character.") -> ())
  and b10 = (try ignore (candidate [Closure identity]);
                failwith "Error not raised" with Primitives_cps.Error("Error in char-numeric?: Closure function is not a character.") -> ())
  and b11 = (try ignore (candidate [Primitive internal_is_char]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in char-numeric?: Primitive function is not a character.") -> ())
  in b0; b1; b2; b3; b4; b5; b6; b7; b8; b9; b10; b11;;
...
let test_internal_char_alphabetic_error candidate =
  (* test for incorrect number of arguments *)
  let b0 = (try ignore (candidate []);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (char-alphabetic? [])") -> ())
  and b1 = (try ignore (candidate [Character 'a'; Character 'A']);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (char-alphabetic? ['a'; 'A'])") -> ())
  and b2 = (try ignore (candidate [Character 'A'; Character 'z'; Character '3']);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (char-alphabetic? ['A'; 'z'; '3'])") -> ())
  and b3 = (try ignore (candidate [Character 'G'; Null]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (char-alphabetic? ['G'; []])") -> ())
  and b4 = (try ignore (candidate [Character 'j'; Null; Int 500]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (char-alphabetic? ['j'; []; 500])") -> ())
  and b5 = (try ignore (candidate [Pair(Character '1',
                                        Character 'a'); Null; Int 500;
                                   Character 'c']);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (char-alphabetic? [('1' , 'a'); []; 500; 'c'])") -> ())
  (* test for incorrect type of argument *)
  and b6 = (try ignore (candidate [Int 5]);
                failwith "Error not raised" with Primitives_cps.Error("Error in char-alphabetic?: 5 is not a character.") -> ())
  and b7 = (try ignore (candidate [Boolean false]);
                failwith "Error not raised" with Primitives_cps.Error("Error in char-alphabetic?: false is not a character.") -> ())
  and b8 = (try ignore (candidate [String "hello"]);
                failwith "Error not raised" with Primitives_cps.Error("Error in char-alphabetic?: \"hello\" is not a character.") -> ())
  and b9 = (try ignore (candidate [Pair(Character 'c',
                                        Character '1')]);
                failwith "Error not raised" with Primitives_cps.Error("Error in char-alphabetic?: ('c' , '1') is not a character.") -> ())
  and b10 = (try ignore (candidate [Closure identity]);
                failwith "Error not raised" with Primitives_cps.Error("Error in char-alphabetic?: Closure function is not a character.") -> ())
  and b11 = (try ignore (candidate [Primitive internal_is_char]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in char-alphabetic?: Primitive function is not a character.") -> ())
  in b0; b1; b2; b3; b4; b5; b6; b7; b8; b9; b10; b11;;
...
let test_internal_is_str_error candidate =
  let b0 = (try ignore (candidate [Pair(Character 'c', Int 3);
                ...
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (string? [('c' , 3); (true , \"9\")])") -> ())
  and b1 = (try ignore (candidate [String "hello" ; String "+"; String "X86_call";
                                   String "taba_paper"]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (string? [\"hello\"; \"+\"; \"X86_call\"; \"taba_paper\"])") -> ())
  and b2 = (try ignore (candidate [Boolean true; Int 5; Character 's';
                                   String "hi"; Null]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (string? [true; 5; 's'; \"hi\"; []])") -> ())
  and b3 = (try ignore (candidate [String "1"; String "ab"]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (string? [\"1\"; \"ab\"])") -> ())
  and b4 = (try ignore (candidate []);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (string? [])") -> ())
  in b0; b1; b2; b3; b4;;
...
let test_internal_str_equal_error candidate =
  ...
  (* test for incorrect type of arguments for single argument case *)
  and b1 = (try ignore (candidate [Int 5]);
                failwith "Error not raised" with Primitives_cps.Error("Error in string=?: 5 is not a string.") -> ())
  and b2 = (try ignore (candidate [Boolean false]);
                failwith "Error not raised" with Primitives_cps.Error("Error in string=?: false is not a string.") -> ())
  and b3 = (try ignore (candidate [Character 'h']);
                failwith "Error not raised" with Primitives_cps.Error("Error in string=?: 'h' is not a string.") -> ())
  and b4 = (try ignore (candidate [Pair(Character 'c',
                                        Character '1')]);
                failwith "Error not raised" with Primitives_cps.Error("Error in string=?: ('c' , '1') is not a string.") -> ())
  and b5 = (try ignore (candidate [Closure identity]);
                failwith "Error not raised" with Primitives_cps.Error("Error in string=?: Closure function is not a string.") -> ())
  and b6 = (try ignore (candidate [Primitive internal_is_char]);
                failwith "Error not raised" with Primitives_cps.Error("Error in string=?: Primitive function is not a string.") -> ())
  (* test for incorrect type of arguments for more than 1 argument case *)
  and b7 = (try ignore (candidate [String "hello"; String "wayne"; Null]);
                failwith "Error not raised" with Primitives_cps.Error("Error in string=?: [] is not a string.") ->())
  ...
  and b10 = (try ignore (candidate [Pair(String "hi",
                                    ...
                                    String "ffxiv"]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in string=?: (\"hi\" , \"there\") is not a string.") ->())
  and b11 = (try ignore (candidate [Character 'f'; String "h"; String "good"]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in string=?: 'f' is not a string.") -> ())
  in b0; b1; b2; b3; b4; b5; b6; b7; b8; b9; b10; b11;;
...
let test_internal_str_length_error candidate = 
  (* test for incorrect number of arguments *)
  let b0 = (try ignore (candidate []);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (string-length? [])") -> ())
  and b1 = (try ignore (candidate [String "hello"; String "there"; String "obi"]);
                failwith  "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (string-length? [\"hello\"; \"there\"; \"obi\"])") -> ())
  and b2 = (try ignore (candidate [String "hello"; String "there"; String "obi";
                                   String "wan"]);
                failwith  "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (string-length? [\"hello\"; \"there\"; \"obi\"; \"wan\"])") -> ())
  and b3 = (try ignore (candidate [String "hello"; Int 5]);
                failwith  "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (string-length? [\"hello\"; 5])") -> ())
  and b4 = (try ignore (candidate [String "hello"; Int 5; Null]);
                failwith  "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (string-length? [\"hello\"; 5; []])") -> ())
  (* test for incorrect type of argument *)
  and b5 = (try ignore (candidate [Int 5]);
                failwith "Error not raised" with Primitives_cps.Error("Error in string-length?: 5 is not a string.") -> ())
  and b6 = (try ignore (candidate [Boolean false]);
                failwith "Error not raised" with Primitives_cps.Error("Error in string-length?: false is not a string.") -> ())
  and b7 = (try ignore (candidate [Character 'h']);
                failwith "Error not raised" with Primitives_cps.Error("Error in string-length?: 'h' is not a string.") -> ())
  and b8 = (try ignore (candidate [Pair(Character 'c',
                                        Character '1')]);
                failwith "Error not raised" with Primitives_cps.Error("Error in string-length?: ('c' , '1') is not a string.") -> ())
  and b9 = (try ignore (candidate [Closure identity]);
                failwith "Error not raised" with Primitives_cps.Error("Error in string-length?: Closure function is not a string.") -> ())
  and b10 = (try ignore (candidate [Primitive internal_is_char]);
                failwith "Error not raised" with Primitives_cps.Error("Error in string-length?: Primitive function is not a string.") -> ())
  in b0; b1; b2; b3; b4; b5; b6; b7; b8; b9; b10;;
...
let test_internal_char_to_str_error candidate =
  ...
  and b1 = (try ignore (candidate [Character '5'; Boolean true]);
                failwith "Error not raised" with Primitives_cps.Error("Error in string: true is not a character.") -> ())
  and b2 = (try ignore (candidate [Character 'a'; Character '-'; Null]);
                failwith "Error not raised" with Primitives_cps.Error("Error in string: [] is not a character.") -> ())
  and b3 = (try ignore (candidate [Character 'a'; Character '-'; Character '1';
                                   String "hello"; Null; Int 5]);
                failwith "Error not raised" with Primitives_cps.Error("Error in string: \"hello\" is not a character.") -> ())
  and b4 = (try ignore (candidate [Character 'a'; Character '-'; Character '1';
                                   Int 5; Primitive internal_cons]);
                failwith "Error not raised" with Primitives_cps.Error("Error in string: 5 is not a character.") -> ())
  and b5 = (try ignore (candidate [Character 'a'; Character '-'; Character '1';
                                   Primitive internal_cons; Closure identity]);
                failwith "Error not raised" with Primitives_cps.Error("Error in string: Primitive function is not a character.") -> ())
  and b6 = (try ignore (candidate [Character 'a'; Character '-'; Character '1';
                                   Closure identity; Pair(Character 'k',
                                                          Character '[')]);
                failwith "Error not raised" with Primitives_cps.Error("Error in string: Closure function is not a character.") -> ())
  and b7 = (try ignore (candidate [Character 'a'; Character '-'; Character '1';
                                   Pair(Character 'k',
                                        Character '['); Character 'p']);
                failwith "Error not raised" with Primitives_cps.Error("Error in string: ('k' , '[') is not a character.") -> ())
  in b0; b1; b2; b3; b4; b5; b6; b7;;
...
let test_internal_str_ref_error candidate =
  let b0 = (try ignore (candidate []);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (string-ref [])") -> ())
  and b1 = (try ignore (candidate [String "String-123"]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (string-ref [\"String-123\"])") -> ())
  and b2 = (try ignore (candidate [String "String-123"; Int 0; Int 1]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (string-ref [\"String-123\"; 0; 1])") -> ())
  and b3 = (try ignore (candidate [String "String-123"; String "0"; Int 1]);
                failwith "Error not raised" with Primitives_cps.Error("Incorrect argument count in call (string-ref [\"String-123\"; \"0\"; 1])") -> ())
  and b4 = (try ignore (candidate [String "String-123"; Int 10]);
                failwith "Error not raised" with Primitives_cps.Error("Error in string-ref: 10 is not a valid index for \"String-123\".")-> ())
  and b5 = (try ignore (candidate [String "String-123"; Int 20]);
                failwith "Error not raised" with Primitives_cps.Error("Error in string-ref: 20 is not a valid index for \"String-123\".")-> ())
  and b6 = (try ignore (candidate [String "String-123"; Character 'c']);
                failwith "Error not raised" with Primitives_cps.Error("Error in string-ref: 'c' is not a valid index for \"String-123\".")-> ())
  and b7 = (try ignore (candidate [String "String-123"; Boolean true]);
                failwith "Error not raised" with Primitives_cps.Error("Error in string-ref: true is not a valid index for \"String-123\".")-> ())
  and b8 = (try ignore (candidate [String "String-123"; String "5"]);
                failwith "Error not raised" with Primitives_cps.Error("Error in string-ref: \"5\" is not a valid index for \"String-123\".")-> ())
  and b9 = (try ignore (candidate [String "String-123"; Pair(Int 0,
                                                             Int 1)]);
                failwith "Error not raised" with Primitives_cps.Error("Error in string-ref: (0 , 1) is not a valid index for \"String-123\".")-> ())
  and b10 = (try ignore (candidate [Int 0; Int 1]);
                failwith "Error not raised" with Primitives_cps.Error("Error in string-ref: 0 is not a string.") -> ())
  and b11 = (try ignore (candidate [Character 'C'; Int 1]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in string-ref: 'C' is not a string.") -> ())
  and b12 = (try ignore (candidate [Boolean true; Int 2]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in string-ref: true is not a string.") -> ())
  and b13 = (try ignore (candidate [Pair(String "hello",
                                         String "world"); Int 2]);
                 failwith "Error not raised" with Primitives_cps.Error("Error in string-ref: (\"hello\" , \"world\") is not a string.") -> ())
  in b0; b1; b2; b3; b4; b5; b6; b7; b8; b9; b10; b11; b12; b13;;
